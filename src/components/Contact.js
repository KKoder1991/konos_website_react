                ...
                <form
                    ...
                    <div className="relative mb-4">
                        ...
                        <textarea
                            id="message"
                            name="message"
                            className="w-full bg-gray-800 rounded border border-gray-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-900 h32 text-base outline-none text-gray-100 py-1 px-3 resize-none leading-6 transtion-colors duration-200 ease-in-out"
